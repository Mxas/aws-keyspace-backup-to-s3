...
public class StringToFloatCodec implements TypeCodec<String> {

	private final TypeCodec<Float> inner;
	private final DataType cqlType;

	StringToFloatCodec() {
		this.cqlType = DataTypes.FLOAT;
		this.inner = TypeCodecs.FLOAT;
	}
	...
	public ByteBuffer encode(@Nullable String value, @NonNull ProtocolVersion protocolVersion) {
		return (value == null) ? null : inner.encode(Float.valueOf(value), protocolVersion);
	}

	@Nullable
	@Override
	public String decode(@Nullable ByteBuffer bytes, @NonNull ProtocolVersion protocolVersion) {
		Float decode = inner.decode(bytes, protocolVersion);
